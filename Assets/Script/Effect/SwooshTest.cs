...
public class SwooshTest : MonoBehaviour
{
    ...
    [SerializeField]  public AnimationState _animationState;
	...
	void Start()
	{
        ...
        //Debug.Log(GetComponent<Animation>()[_animation.name]);
        //Debug.Log(_animation.name);
        //Debug.Log(GetComponent<Animation>()["standing_melee_attack_downward"]);
        Debug.Log(GetComponent<Animation>());
        _trail.Emit = false;
	}
